...
# === Configuration ===
INPUT_CSV  = "Cinnamon_Sem_Two_Recorded.csv"              # original file (won't be overwritten)
OUTPUT_CSV = "Cinnamon_Sem_Two_Recorded_reordered.csv"    # new file with corrected ordering
...
# === Console report ===
print("=== Loop Reconstruction Report (Cinnamon) ===")
